...
// ─── Data ─────────────────────────────────────────────────────────────────────
const questions = [
  'هل أنت قيادي صاعد ومتحمس وتتطلع للنجاح؟',
  'هل ترغب في تطوير ذاتك وأساليب إدارتك من خلال فهم نماذج عالمية وتجارب محلية؟',
  'هل تقود الآخرين سواء كنت مديرًا أو موظفًا أو رياديا كان عملك تطوعيا أو حكوميًا؟',
]
    ...
    <section style={{ backgroundColor: t.bg, padding: '60px 0' }}>
      <div style={{ maxWidth: '780px', margin: '0 auto', padding: '0 24px' }}>
        ...
        <p style={{
          ...
          ، وتعلمت من رحلتي الكثير. مررت بتجارب عديدة في العمل الحكومي والأكاديمي وتأسيس الأعمال وريادتها وإدارة الشركات متعددة الجنسية وقيادة المنظمات المحلية الكبرى.
        </p>
        ...
        <p style={{
          ...
          تعلمت من نجاحاتي ومن فشلي الكثير! وأسعد أنني تعلمت من هذا الفشل أضعاف ما تعلمته من نجاحاتي.
        </p>
        ...
        <p style={{
          ...
          أنشأت هذه المدونة بعدما شعرت بأن هناك شحا في توثيق الأفكار والتجارب القيادية الحديثة باللغة العربية. فمن خلالها أطمح لمساعدتك في فهم وتطبيق نماذج إدارية وقيادية مجربة لتدلك على النجاح في رحلتك المهنية. فالمدونة تقدم بلغة مبسطة ومختصرة نصائح مجربة في تحسين أسلوب القيادة وإدارة الفرق. وتتطرق أيضا إلى إدارة الذات والوقت والنجاح في الحياة، وأحيانا أدون مجرد تجاربي الشخصية وخواطري.
        </p>
      </div>
    </section>
  )
...
function PopularArticles() {
  ...
  useEffect(() => {
    supabase.from('articles').select('id, title, category, excerpt, date, sort_date, featured, bg, img, title_en, excerpt_en, date_en').order('featured', { ascending: false }).order('sort_date', { ascending: false, nullsFirst: false }).order('id', { ascending: false }).limit(2).then(({ data }) => {
